...
Elm.Van = Elm.Van || {};
Elm.Van.make = function (_elm) {
   "use strict";
   _elm.Van = _elm.Van || {};
   if (_elm.Van.values)
   return _elm.Van.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var riding_state_to_str = function (riding_state) {
      return function () {
         switch (riding_state.ctor)
         {case "In": return "in";
            case "Not": return "not";
            case "Out": return "out";
            case "RoundTrip":
   ...
   var rs_to_pretty = function (rs) {
      return function () {
         switch (rs.ctor)
         {case "In": return "In";
            case "Not": return "Not Riding";
            case "Out": return "Out";
            case "RoundTrip":
            return "Round Trip";
            case "Undecided":
   ...
   var style_button = F2(function (current_state,
   set_state) {
      return _U.eq(current_state,
      set_state) ? $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                        ,_0: "color"
                                                        ,_1: "blue"}])) : $Html$Attributes.style(_L.fromArray([]));
   });
   var ride_button = F3(function (address,
   van,
   rs) {
      ...
      _L.fromArray([A2($Html$Events.onClick,
                   ...
                   van.state,
                   rs)]),
      _L.fromArray([$Html.text(rs_to_pretty(rs))]));
   });
   var Van = F2(function (a,b) {
      return {_: {}
             ,number: a
             ,state: b};
   });
   var Undecided = {ctor: "Undecided"};
   var model = {_: {}
               ,number: 1
               ,state: Undecided};
   var Not = {ctor: "Not"};
   ...
   var Out = {ctor: "Out"};
   var In = {ctor: "In"};
   var RoundTrip = {ctor: "RoundTrip"};
   var view = F2(function (address,
   van) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A3(ride_button,
                   address,
                   van,
                   In)
                   ,A3(ride_button,address,van,Out)
                   ,A3(ride_button,
                   address,
                   van,
                   RoundTrip)
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(rs_to_pretty(van.state))]))]));
   });
   var main = $StartApp.start({_: {}
                              ,model: model
                              ,update: update
                              ,view: view});
   _elm.Van.values = {_op: _op
                     ,RoundTrip: RoundTrip
                     ,In: In
                     ,Out: Out
                     ,Not: Not
                     ...
                     ,model: model
                     ,update: update
                     ,ride_button: ride_button
                     ,view: view
                     ,style_button: style_button
                     ,rs_to_pretty: rs_to_pretty
                     ,riding_state_to_str: riding_state_to_str
                     ,main: main};
   return _elm.Van.values;
};
